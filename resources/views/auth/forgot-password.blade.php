...
<head>
    ...
    <title>Forgot Password — {{ config('saas.platform_name', 'VMARKET POS') }}</title>
...
<body>
    ...
    <div class="login-card">
        <div class="brand-header">
            ...
            <div class="portal-badge">🏢 TENANT RECOVERY</div>
            <h1>Forgot Your Password?</h1>
            <p>Enter your business email address and we'll send you a secure link to reset your account password.</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}" id="forgotForm">
            ...
            <div class="form-group">
                <label for="email">Business Account Email</label>
                <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="owner@yourstore.com" required autofocus>
            </div>
        ...
        <div style="margin-top: 1.75rem; text-align: center; border-top: 1px solid rgba(255, 255, 255, 0.08); padding-top: 1.25rem;">
            <a href="{{ route('portal.tenant.login') }}" style="color: var(--text-muted); font-size: 0.88rem; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 0.35rem;">
                ← Return to Tenant Sign In
            </a>
        </div>
    </div>

    <script>
        // Enter-key advancement
