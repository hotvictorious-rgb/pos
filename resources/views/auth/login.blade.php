        ...
        <form method="POST" action="{{ route('login.post') }}">
            ...
            <div class="form-group">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.4rem;">
                    ...
                    <a href="{{ \Illuminate\Support\Facades\Route::has('password.request') ? route('password.request') : url('/forgot-password') }}" style="color: #93c5fd; font-size: 0.8rem; text-decoration: none; font-weight: 600; transition: color 0.15s;" title="Recover account password">
                        Forgot Password?
                    </a>
                </div>
